...
export default function GestionPage() {
  ...
  const load = useCallback(async () => {
    try {
      ...
      const [
        ...
        { data:cp }, { data:pc }, { data:df }, { data:mtr },
        { data:unidades },
        { data:transRaw },
      ] = await Promise.all([
  ...
  // Finanzas, técnica y comercial pueden editar asignaciones/ventas. Obra solo lectura.
  const puedeEditar = ['finanzas','comercial','admin'].includes(data.perfil?.sector)
